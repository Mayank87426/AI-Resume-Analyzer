...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (result?.success && result.data?._id) {
            navigate(`/interview/${result.data._id}`, { state: { report: result.data } })
        } else {
            setError(result?.error || "Failed to generate interview plan. Please try again.")
        }
    }
    ...
    if (loading) {
        return (
            <main className="loading-screen">
                ...
                <h1>Crafting your interview strategy...</h1>
            </main>
        )
    }
