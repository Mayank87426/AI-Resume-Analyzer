...
const getScoreLabel = (score) => {
    ...
    if (score >= 60) return "Good match — focus on key gaps"
    if (score >= 40) return "Moderate match — preparation recommended"
    return "Needs improvement — follow the roadmap"
}
...
const Interview = () => {
    ...
    const isEmpty = report && !technicalQuestions.length && !behavioralQuestions.length && !preparationPlan.length
    ...
    if (isEmpty) {
        return (
            <main className="loading-screen">
                <span className="orb orb--pink" />
                <span className="orb orb--purple" />
                <h1>This plan has no content</h1>
                <p style={{ color: '#9ca3c7', textAlign: 'center', maxWidth: 400 }}>
                    It was saved before a fix. Please generate a new interview plan from the home page.
                </p>
